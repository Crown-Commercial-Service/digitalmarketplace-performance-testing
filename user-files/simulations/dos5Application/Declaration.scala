...
object Declaration {
	...
	val declaration = exec(http("declaration_request_6")
		...
		.pause(1)
		.exec(http("declaration_request_14")
		...
		.pause(1)
		.exec(http("declaration_request_15")
		...
		.pause(1)
		.exec(http("declaration_request_16")
		...
		.pause(1)
		.exec(http("declaration_request_17")
		...
		.pause(1)
		.exec(http("declaration_request_18")
		...
		.pause(1)
		.exec(http("declaration_request_19")
		...
		.pause(1)
		.exec(http("declaration_request_20")
