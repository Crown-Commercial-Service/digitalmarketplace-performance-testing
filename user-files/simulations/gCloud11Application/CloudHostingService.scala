...
object CloudHostingService {
	...
	val chain_0 = exec(http("hosting_service_request_0")
		...
		.exec(http("hosting_service_request_3")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0003_request.txt"))
		...
		.exec(http("hosting_service_request_5")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0005_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_6")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0006_request.txt")))
		.pause((sp*23).toInt)
		...
		.exec(http("hosting_service_request_8")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0008_request.txt")))
		.pause((sp*23).toInt)
		...
		.exec(http("hosting_service_request_10")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0010_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_11")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0011_request.txt")))
		.pause((sp*23).toInt)
		...
		.exec(http("hosting_service_request_13")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0013_request.txt")))
		.pause((sp*23).toInt)
		...
		.exec(http("hosting_service_request_15")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0015_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_16")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0016_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_17")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0017_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_18")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0018_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_19")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0019_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_20")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0020_request.txt")))
		.pause((sp*23).toInt)
		...
		.exec(http("hosting_service_request_22")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0022_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_23")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0023_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_24")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0024_request.txt")))
		.pause((sp*23).toInt)
		...
		.exec(http("hosting_service_request_26")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0026_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_27")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0027_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_28")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0028_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_29")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0029_request.txt")))
		.pause((sp*23).toInt)
		...
		.exec(http("hosting_service_request_31")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0031_request.txt")))
		.pause((sp*23).toInt)
		...
		.exec(http("hosting_service_request_33")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0033_request.txt")))
		.pause((sp*23).toInt)
		...
		.exec(http("hosting_service_request_35")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0035_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_36")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0036_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_37")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0037_request.txt")))
		.pause((sp*23).toInt)
		...
		.exec(http("hosting_service_request_39")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0039_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_40")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0040_request.txt")))
		.pause((sp*23).toInt)
		...
		.exec(http("hosting_service_request_42")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0042_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_43")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0043_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_44")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0044_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_45")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0045_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_46")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0046_request.txt")))
		.pause((sp*23).toInt)
		.exec(http("hosting_service_request_47")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0047_request.txt")))
		.pause((sp*23).toInt)
		...
		.exec(http("hosting_service_request_49")
			...
			.headers(headers_3)
			.body(RawFileBody("gCloud11Application/CloudHostingService_0049_request.txt")))
		.pause((sp*23).toInt)
	...
	val chain_1 = exec(http("hosting_service_request_50")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0050_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_51")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0051_request.txt")))
			.pause((sp*23).toInt)
			...
			.exec(http("hosting_service_request_53")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0053_request.txt")))
			.pause((sp*23).toInt)
			...
			.exec(http("hosting_service_request_55")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0055_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_56")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0056_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_57")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0057_request.txt")))
			.pause((sp*23).toInt)
			...
			.exec(http("hosting_service_request_59")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0059_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_60")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0060_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_61")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0061_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_62")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0062_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_63")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0063_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_64")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0064_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_65")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0065_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_66")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0066_request.txt")))
			.pause((sp*23).toInt)
			...
			.exec(http("hosting_service_request_68")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0068_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_69")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0069_request.txt")))
			.pause((sp*23).toInt)
			...
			.exec(http("hosting_service_request_71")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0071_request.txt")))
			.pause((sp*23).toInt)
			...
			.exec(http("hosting_service_request_73")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0073_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_74")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0074_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_75")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0075_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_76")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0076_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_77")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0077_request.txt")))
			.pause((sp*23).toInt)
			...
			.exec(http("hosting_service_request_79")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0079_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_80")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0080_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_81")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0081_request.txt")))
			.pause((sp*23).toInt)
			...
			.exec(http("hosting_service_request_83")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0083_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_84")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0084_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_85")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0085_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_86")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0086_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_87")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0087_request.txt")))
			.pause((sp*23).toInt)
			...
			.exec(http("hosting_service_request_89")
				.post("/suppliers/frameworks/g-cloud-11/submissions/cloud-hosting/${cloud_hosting_service_id}/edit/energy-efficiency/energy-efficiency")
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0089_request.txt")))
			.pause((sp*23).toInt)
			...
			.exec(http("hosting_service_request_91")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0091_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_92")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0092_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_93")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0093_request.txt")))
			.pause((sp*23).toInt)
			...
			.exec(http("hosting_service_request_95")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0095_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_96")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0096_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_97")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0097_request.txt")))
			.pause((sp*23).toInt)
			.exec(http("hosting_service_request_98")
				...
				.headers(headers_3)
				.body(RawFileBody("gCloud11Application/CloudHostingService_0098_request.txt")))
			.pause((sp*23).toInt)
